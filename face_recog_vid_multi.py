...
def capture(read_frame_list, Global, worker_num):
    ...
    while not Global.is_exit:
        print(f"Global.buff_num = {Global.buff_num} next_id(Global.read_num, worker_num) = {next_id(Global.read_num, worker_num)}")
...
def process(worker_id, read_frame_list, write_frame_list, Global, worker_num):
    ...
    while not Global.is_exit:
        ...
        #print(f"Inside process: {worker_id} Global.read_num = {Global.read_num} prev_id(Global.buff_num) = {prev_id(Global.buff_num, worker_num)}")
        # Wait to read
